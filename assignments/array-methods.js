...
// Problem 1 List of donations over $50
let over50 = runners.filter(runner => {
...
// Problem 2 Shirt Size Small only
let smallShirts = [];
smallShirts = runners.filter(runner =>
    runner.shirt_size === 'S'); 

console.log(smallShirts);

// Problem 3 List of last name only
let lastName = [];
runners.forEach(function(runnerName) {
    lastName.push(runnerName.last_name);
});
